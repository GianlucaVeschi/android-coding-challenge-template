    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/gianlucaveschi/androidkotlintemplate/")
                ...
                developers {
                    developer {
                        id.set("gianlucaveschi")
                        name.set("gianlucaveschi")
                    }
                }
                scm {
                    connection.set("scm:git:git://github.com/gianlucaveschi/androidkotlintemplate.git")
                    developerConnection.set("scm:git:ssh://github.com/gianlucaveschi/androidkotlintemplate.git")
                    url.set("https://github.com/gianlucaveschi/androidkotlintemplate/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/gianlucaveschi/androidkotlintemplate/issues")
                }
            }
        }
    }
